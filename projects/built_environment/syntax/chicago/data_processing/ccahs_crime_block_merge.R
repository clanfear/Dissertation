...
load("../shared/data/chicago/derived/cpd_crimes_block.RData")
load("../shared/data/chicago/derived/crosswalks/complete_crosswalk.RData")
load("./data/chicago/derived/ccahs_sso_block.RData")
load("../shared/data/chicago/derived/block_pop_estimates_2000.RData")
...
save(ccahs_block_sso_crime, file = "./data/chicago/derived/ccahs_block_sso_crime.RData")
